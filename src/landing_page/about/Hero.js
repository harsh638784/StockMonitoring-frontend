...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-5 mb border-top text-muted fs-6">
        ...
        <div className="col-6 p-5">
          <p>
            ...
            <br></br>
           <p> Rainmatter, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
                </p>
            <br></br>
